...
int background=-15662850;
	
		if (background!=mouseColor&&mouseColor!=-14945231){
...
scare();
	...
	@Override
	public void run() {
		JFrame frame = new JFrame("Ryan's Scary Maze");
		frame.add(this);
